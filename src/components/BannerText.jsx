...
function BannerText() {
  return (
    <div className="max-w-3xl self-center text-pretty py-6 text-center md:basis-1/2 md:py-0 md:text-start">
      <h1 className="mb-3 px-2 font-heading text-2xl font-bold md:mb-6 md:px-0 md:text-4xl md:leading-[1.3] lg:text-5xl">
        Discover the Future of Tech
      </h1>
      <p className="mb-4 px-6 opacity-90 md:mb-8 md:px-0 md:text-xl md:leading-[1.3]">
